...
if __name__ == '__main__':
    ...
    state_dict = torch.load(r'C:\Users\rlucasse\Documents\repositories\tissue_alignment\vit_wee_patch16_reg1_gap_256.sbb_in1k.pth')
    ...
    # for reference, the code that I used the get the state_dict file of the timm ViT
    # import timm
    ...
    # torch.save(state_dict, 'vit_wee_patch16_reg1_gap_256.sbb_in1k.pth')